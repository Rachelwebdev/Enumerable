...
```sh
  git clone https://github.com/rachelwebdev/Enumerable.git
  cd enumerable
...
Feel free to check the [issues page](https://github.com/rachelwebdev/Enumerable/issues).
...
- Created a class `MyList` that has an instance variable `@list`
- Implemented a method `#each` that yields successive members of `@list` and uses the MyEnumerable module
- Created a module MyEnumerable that implements the following methods : 
#all?
#any?
#filter